...
<script type="text/javascript">
	function fn_chk() {
        ...
        //alert("sum->"+sum);
        frm.total_sum.value = sum+shipping_fee;
					...
					<c:forEach var="cartList2" items="${cartList}" varStatus="status">
						<tr height="300">
							...
							<td><img width="200" src="${cartList2.getImgPath() }"
								name="pdImage"></td>
							<td width="200" align="center">${cartList2.getPd_name() }</td>
							<td width="200" align="center">${cartList2.getPd_price()}원</td>
							<td width="100"><input type="number" name="pd_qty"
								value="${cartList2.getQty() }" min="1" onchange="fn_chk()">
								<p>
									<input type="button" style="float: right" value="장바구니에서 삭제"
										onclick="location.href='cartDeletePro.do?pd_code=${cartList2.getPd_code() }'"></td>
							<c:if test="${status.first}">
								<td width="200" align="center" rowspan="${cartList.size() }">2500원</td>
							</c:if>
						</tr>
